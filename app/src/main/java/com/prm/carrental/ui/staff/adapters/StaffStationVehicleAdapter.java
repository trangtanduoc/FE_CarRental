...
public class StaffStationVehicleAdapter extends RecyclerView.Adapter<StaffStationVehicleAdapter.StaffStationVehicleViewHolder>{
    private Context context;
    private List<VehicleDto> vehicleList;
    private StaffStationVehicleAdapter.OnStaffStationVehicleClickListener listener;

    // ===== THÊM INTERFACE NÀY =====
    public interface OnStaffStationVehicleClickListener {
    ...
    public StaffStationVehicleAdapter(Context context, List<VehicleDto> vehicleList, StaffStationVehicleAdapter.OnStaffStationVehicleClickListener listener) {
    ...
    @NonNull
    @Override
    public StaffStationVehicleAdapter.StaffStationVehicleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_vehicle, parent, false);
        return new StaffStationVehicleAdapter.StaffStationVehicleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull StaffStationVehicleAdapter.StaffStationVehicleViewHolder holder, int position) {
...
//        });
    ...
    public static class StaffStationVehicleViewHolder extends RecyclerView.ViewHolder {
        ImageView imgVehicle;
        TextView tvVehiclePlate, tvType, tvVehicleStatus, tvVehicleBattery;
        ImageButton btnDelete;

        public StaffStationVehicleViewHolder(@NonNull View itemView) {
            super(itemView);
